...
export default function Home() {
  return (
    <>
      <section className='h-full w-full md:pt-[40rem] mt-[-70px] relative flex items-center justify-center flex-col '>
        {/* grid */}
      ...
      <section className='flex justify-center items-center flex-col gap-4 md:!mt-[30rem] mt-[-60px]'>
        <h2 className='text-4xl text-center'>Choose what fits your right</h2>
        <p className='text-muted-foreground text-center'>
          Our straighforward pricing plans are tailored to meet your needs. If
            ...
            <Card
              ...
              <CardFooter className='flex flex-col items-start gap-4'>
                ...
                <Link
                  ...
                  className={clsx(
                    'w-full text-center bg-primary p-2 rounded-md text-primary-foreground',
                    {
